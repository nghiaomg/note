...
for (let i = 0; i < window.localStorage.getItem('countNote'); i++) {
    if(window.localStorage.getItem(i) !== null){
            ...
            <h5 class="text-right font-bold tracking-tight text-gray-900 dark:text-white">
                <button type="button" data-toggle="modal" data-target="#modalAccess" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2 mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
            ...
            <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Note 1</h5>
            <p class="font-normal text-gray-700 dark:text-gray-400">
            Theo Báo cáo thị trường IT Việt Nam năm 2022 do TopDev phát hành, mức lương lập trình viên mới vào nghề dưới 2 năm kinh nghiệm rơi vào khoảng 350 USD (8,3 triệu đồng). Mức lương này tăng lên đến 1.190 USD (28 triệu đồng) cho vị trí Mid-Senior (trung cấp).
            </p>
        </a>
